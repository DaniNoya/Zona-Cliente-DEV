                ...
                <div class="col-sm-8">
                    <div class="welcome-container">
                        <div class="welcome-icon">
                            <img src="{{ asset('assets/ilusiona_logo.png') }}" class="welcome-logo">
                        </div>
                        <div class="welcome-text">
                            <h1 class="m-0"><strong>Bienvenido de nuevo, [usuario]</strong></h1>
                            <p class="welcome-subtitle">Accede a tu panel personalizado</p>
                ...
                <div class="col-md-10">
                    <div class="card card-info shadow-lg">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-building mr-2"></i>Centro de Ocio</h3>
                        </div>
                        <div class="card-body">
                            <x-adminlte-select name="selVehicle" 
                                ...
                                <option disabled selected> -- Centros de ocio disponibles -- </option>
